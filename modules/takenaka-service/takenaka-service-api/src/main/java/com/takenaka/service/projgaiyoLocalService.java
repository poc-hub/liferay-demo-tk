...
/**
 * Provides the local service interface for projgaiyo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sanjay.Panchal
 * @see projgaiyoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface projgaiyoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link projgaiyoLocalServiceUtil} to access the projgaiyo local service. Add custom service methods to <code>com.takenaka.service.impl.projgaiyoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
