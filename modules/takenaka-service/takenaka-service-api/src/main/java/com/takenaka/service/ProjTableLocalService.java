...
/**
 * Provides the local service interface for ProjTable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sanjay.Panchal
 * @see ProjTableLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProjTableLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProjTableLocalServiceUtil} to access the proj table local service. Add custom service methods to <code>com.takenaka.service.impl.ProjTableLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
