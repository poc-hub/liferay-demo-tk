...
/**
 * Provides the local service interface for TriggerMeeting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sanjay.Panchal
 * @see TriggerMeetingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TriggerMeetingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TriggerMeetingLocalServiceUtil} to access the trigger meeting local service. Add custom service methods to <code>com.takenaka.service.impl.TriggerMeetingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public TriggerMeeting findByMeetingId(String meetingId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TriggerMeeting> getTriggerMeetingByFilter(
		String meetingType, String meetingId, String issuer,
		String meetingTitle, Date meetDateStr, Date meetDateEnd);
