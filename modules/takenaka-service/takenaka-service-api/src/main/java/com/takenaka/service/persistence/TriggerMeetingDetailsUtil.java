...
/**
 * The persistence utility for the trigger meeting details service. This utility wraps <code>com.takenaka.service.persistence.impl.TriggerMeetingDetailsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TriggerMeetingDetailsPersistence
 * @generated
 */
public class TriggerMeetingDetailsUtil {
	 ...
	 */
	public static void clearCache(TriggerMeetingDetails triggerMeetingDetails) {
		getPersistence().clearCache(triggerMeetingDetails);
	}
	 ...
	 */
	public static Map<Serializable, TriggerMeetingDetails> fetchByPrimaryKeys(
	 ...
	 */
	public static List<TriggerMeetingDetails> findWithDynamicQuery(
	 ...
	 */
	public static TriggerMeetingDetails update(
		TriggerMeetingDetails triggerMeetingDetails) {

		return getPersistence().update(triggerMeetingDetails);
	}
	...
	public static TriggerMeetingDetails update(
		...
		return getPersistence().update(triggerMeetingDetails, serviceContext);
	}
	 ...
	 */
	public static TriggerMeetingDetails findByfindByMeetingSeqno(
			long meetingSeqno)
		throws com.takenaka.exception.NoSuchTriggerMeetingDetailsException {

		return getPersistence().findByfindByMeetingSeqno(meetingSeqno);
	}
	 ...
	 */
	public static TriggerMeetingDetails fetchByfindByMeetingSeqno(
		long meetingSeqno) {

		return getPersistence().fetchByfindByMeetingSeqno(meetingSeqno);
	}
	...
	public static TriggerMeetingDetails fetchByfindByMeetingSeqno(
		...
		return getPersistence().fetchByfindByMeetingSeqno(
			meetingSeqno, useFinderCache);
	}
	 ...
	 */
	public static TriggerMeetingDetails removeByfindByMeetingSeqno(
			long meetingSeqno)
		throws com.takenaka.exception.NoSuchTriggerMeetingDetailsException {

		return getPersistence().removeByfindByMeetingSeqno(meetingSeqno);
	}
	 ...
	 */
	public static int countByfindByMeetingSeqno(long meetingSeqno) {
		return getPersistence().countByfindByMeetingSeqno(meetingSeqno);
	}
	 ...
	 */
	public static List<TriggerMeetingDetails> findByfindByMeetingSeqnoList(
		long meetingSeqno) {

		return getPersistence().findByfindByMeetingSeqnoList(meetingSeqno);
	}
	...
	public static List<TriggerMeetingDetails> findByfindByMeetingSeqnoList(
		...
		return getPersistence().findByfindByMeetingSeqnoList(
			meetingSeqno, start, end);
	}
	...
	public static List<TriggerMeetingDetails> findByfindByMeetingSeqnoList(
		...
		return getPersistence().findByfindByMeetingSeqnoList(
			meetingSeqno, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchTriggerMeetingDetailsException if a matching trigger meeting details could not be found
	 */
	public static TriggerMeetingDetails findByfindByMeetingSeqnoList_First(
			long meetingSeqno,
			OrderByComparator<TriggerMeetingDetails> orderByComparator)
		throws com.takenaka.exception.NoSuchTriggerMeetingDetailsException {

		return getPersistence().findByfindByMeetingSeqnoList_First(
	 ...
	 */
	public static TriggerMeetingDetails fetchByfindByMeetingSeqnoList_First(
		long meetingSeqno,
		OrderByComparator<TriggerMeetingDetails> orderByComparator) {

		return getPersistence().fetchByfindByMeetingSeqnoList_First(
			meetingSeqno, orderByComparator);
	}
	 ...
	 * @throws NoSuchTriggerMeetingDetailsException if a matching trigger meeting details could not be found
	 */
	public static TriggerMeetingDetails findByfindByMeetingSeqnoList_Last(
			long meetingSeqno,
			OrderByComparator<TriggerMeetingDetails> orderByComparator)
		throws com.takenaka.exception.NoSuchTriggerMeetingDetailsException {

		return getPersistence().findByfindByMeetingSeqnoList_Last(
			meetingSeqno, orderByComparator);
	}
	 ...
	 */
	public static TriggerMeetingDetails fetchByfindByMeetingSeqnoList_Last(
		long meetingSeqno,
		OrderByComparator<TriggerMeetingDetails> orderByComparator) {

		return getPersistence().fetchByfindByMeetingSeqnoList_Last(
			meetingSeqno, orderByComparator);
	}
	 ...
	 */
	public static TriggerMeetingDetails[]
			findByfindByMeetingSeqnoList_PrevAndNext(
				long meetingdetailSeqno, long meetingSeqno,
				OrderByComparator<TriggerMeetingDetails> orderByComparator)
		throws com.takenaka.exception.NoSuchTriggerMeetingDetailsException {

		return getPersistence().findByfindByMeetingSeqnoList_PrevAndNext(
			meetingdetailSeqno, meetingSeqno, orderByComparator);
	}
	 ...
	 * @param meetingSeqno the meeting seqno
	 */
	public static void removeByfindByMeetingSeqnoList(long meetingSeqno) {
		getPersistence().removeByfindByMeetingSeqnoList(meetingSeqno);
	}
	 ...
	 * @return the number of matching trigger meeting detailses
	 */
	public static int countByfindByMeetingSeqnoList(long meetingSeqno) {
		return getPersistence().countByfindByMeetingSeqnoList(meetingSeqno);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(triggerMeetingDetails);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(triggerMeetingDetailses);
	}
	 ...
	 */
	public static TriggerMeetingDetails create(long meetingdetailSeqno) {
		return getPersistence().create(meetingdetailSeqno);
	}
	 ...
	 * @throws NoSuchTriggerMeetingDetailsException if a trigger meeting details with the primary key could not be found
	 */
	public static TriggerMeetingDetails remove(long meetingdetailSeqno)
		throws com.takenaka.exception.NoSuchTriggerMeetingDetailsException {

		return getPersistence().remove(meetingdetailSeqno);
	}

	public static TriggerMeetingDetails updateImpl(
		TriggerMeetingDetails triggerMeetingDetails) {

		return getPersistence().updateImpl(triggerMeetingDetails);
	}
	 ...
	 * @throws NoSuchTriggerMeetingDetailsException if a trigger meeting details with the primary key could not be found
	 */
	public static TriggerMeetingDetails findByPrimaryKey(
			long meetingdetailSeqno)
		throws com.takenaka.exception.NoSuchTriggerMeetingDetailsException {

		return getPersistence().findByPrimaryKey(meetingdetailSeqno);
	}
	 ...
	 */
	public static TriggerMeetingDetails fetchByPrimaryKey(
		long meetingdetailSeqno) {

		return getPersistence().fetchByPrimaryKey(meetingdetailSeqno);
	}
	 ...
	 */
	public static List<TriggerMeetingDetails> findAll() {
	 ...
	 */
	public static List<TriggerMeetingDetails> findAll(int start, int end) {
	...
	public static TriggerMeetingDetailsPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<TriggerMeetingDetailsPersistence, TriggerMeetingDetailsPersistence>
			_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			TriggerMeetingDetailsPersistence.class);

		ServiceTracker
			<TriggerMeetingDetailsPersistence, TriggerMeetingDetailsPersistence>
				serviceTracker =
					new ServiceTracker
						<TriggerMeetingDetailsPersistence,
						 TriggerMeetingDetailsPersistence>(
							 bundle.getBundleContext(),
							 TriggerMeetingDetailsPersistence.class, null);
