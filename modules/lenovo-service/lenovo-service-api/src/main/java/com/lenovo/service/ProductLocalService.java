...
public interface ProductLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProductLocalServiceUtil} to access the product local service. Add custom service methods to <code>com.lenovo.service.impl.ProductLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
